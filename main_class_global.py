...
class TopMain(tkinter.Tk):
    ...
    def fn_Menu(self):
        ...
        # btn_tx_sum = Button(window_Menu, width=30, height=3, text='Tx Summary', command=func_tx_summ)
...
class Viewer(object):
    ...
    def initialize(self):
        ...
        btn_view = Button(frame1, width=15, height=2, text='Select Table', command=self.fn_select_table)
